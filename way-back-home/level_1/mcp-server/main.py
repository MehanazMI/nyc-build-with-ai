...
def analyze_geological(
    ...
    Returns:
        dict containing biome, confidence, minerals_detected, description
    """
...
def analyze_botanical(
    ...
    Returns:
        dict containing biome, confidence, species_detected, audio_signatures, visual_features, description
    """
